  ...
  Widget _crearFondo(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        ...
        Positioned(top: -40,right: -30,child: ciruclo,),
        Positioned(top: -40,right: -30,child: ciruclo,),
        Positioned(bottom: -50,right: -10,child: ciruclo,),
        Positioned(bottom: 120,right: 20,child: ciruclo,),
        Positioned(bottom: -50, left: -20,child: ciruclo,),
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Fernando Herrera', style: TextStyle(fontSize: 25.0, color: Colors.white),)
            ],
          ),
        )
      ],
